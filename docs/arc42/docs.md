...
|------------|-------------|
| **Technologie** | Python, Apache Kafka, Apache Zookeeper, Docker, MySQL |
| **Message Broker** | Apache Kafka pour la gestion des événements asynchrones |
| **Coordination** | Apache Zookeeper pour la coordination du cluster Kafka |
...
- **Coordination** : Apache Zookeeper pour la gestion du cluster Kafka
